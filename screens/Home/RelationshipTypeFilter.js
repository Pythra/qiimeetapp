...
const RelationshipTypeFilter = ({ navigation }) => {
  const [selected, setSelected] = useState([]);
  const options = ['Life Partner', 'Long-Term Partner', 'Long-Term Connection', 'Short-Term Connection', 'Build a Future Together'];
