      ...
      if (data.success && data.token && data.user) {
        ...
        if (loginSuccess) {
          ...
          if (route.params && route.params.fromSignIn) {
            ...
            // For new signup, navigate to Onboarding stack which will start with Welcome screen
        ...
        try {
          ...
          if (userResponse.ok) {
            ...
            // Store signup flag before login to prevent auto-navigation to MainTabs
            if (route.params && route.params.fromSignIn === false) {
              await AsyncStorage.setItem('isNewSignup', 'true');
              console.log('🔍 [VerificationCode] Marked as new signup');
            }
            ...
            if (loginSuccess) {
              ...
              console.log('🔍 [VerificationCode] Route params:', route.params);
              console.log('🔍 [VerificationCode] fromSignIn value:', route.params?.fromSignIn);
              
              if (route.params && route.params.fromSignIn === true) {
                console.log('🔍 [VerificationCode] Navigating to MainTabs (signin)');
                navigation.navigate('MainTabs');
              } else {
                console.log('🔍 [VerificationCode] New signup - letting Index.js handle navigation');
                // For new signup, don't navigate here - let the Index.js useEffect handle it
                // This prevents race conditions between VerificationCodeScreen and Index.js
              }
            } else {
              setError('Login failed. Please try again.');
            }
